...
\begin{cv}{\spacedallcaps{Cecilia Di Maulo} \ \ \ \ \ \ \  \color{black}\large\emph{25 ans}, italienne}\vspace{2em} % Your name
...
%----------------------------------------------------------------------------------------
  ...
  \Description{\MarginText{Osones}Mission : \'elaboration d'une plateforme OpenStack offline au d\'eploiement compl\`etement automatis\'e
         \begin{itemize}
             \item {\'{E}laboration de l'architecture (12 serveurs)} 
        \item {\'{E}valuation et mise en place d'un outil de d\'eploiement baremetal}
        \item {\'{E}valuation et mise en place d'outils de mirroring}
